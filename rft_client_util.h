 ...
 *      client will terminate with a fatal memory error. The relevant segment
 *      of the given protocol structure is initialed.
 ...
 */
void send_data(protocol_t* proto); // they implement
 ...
 */
void send_file_with_timeout(protocol_t* proto); // they implement
 ...
 */
void set_udp_socket(protocol_t* proto); // they implement
